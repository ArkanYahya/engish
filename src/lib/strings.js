...
export const STRINGS = {
  en: {
    ...
    grammarBonusBadge: "Bonus",
    grammarBonusNote: "This topic isn't tested in the quiz — it's here as extra background.",
    quizMe: "Quiz Me",
  ...
  ar: {
    ...
    grammarBonusBadge: "إضافي",
    grammarBonusNote: "هذا الموضوع غير مُختبر في الاختبار — إنه هنا كمعلومة إضافية.",
